...
var connectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/sports-activity-center')];
            case 1:
                conn = _a.sent();
...
var createAdminUser = function () { return __awaiter(void 0, void 0, void 0, function () {
    var adminExists, admin, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, 4, 6]);
                return [4 /*yield*/, User_1.default.findOne({ email: 'admin@qq.com' })];
            case 1:
                adminExists = _a.sent();
                if (adminExists) {
